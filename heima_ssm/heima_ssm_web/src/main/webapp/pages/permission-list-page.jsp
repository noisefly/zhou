                            ...
                            <c:forEach items="${pageInfo.list}" var="p">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/permission/xx?id=${p.id}"
                                           class="btn bg-olive btn-xs"><%--详情--%></a>
                                        <a href="${pageContext.request.contextPath}/permission/xxx?id=${p.id}"
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNumber" >
                                <li><a href="${pageContext.request.contextPath}/permission/findAll?page=${pageNumber}&size=${pageInfo.pageSize}">${pageNumber}</a></li>
                            </c:forEach>
                <%--
                            <li><a href="#">1</a></li>
                            <li><a href="#">2</a></li>
