    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                <%--用户名显示--%><p> <security:authentication property="principal.username"/></p>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <%--   *****没有ADMIN角色不显示用户管理***--%>
                    <section:authorize access="hasAnyRole('ADMIN','VIP')">
                    <%--<section:authorize  access="hasRole('ADMIN')"/>--%>

                    <li id="system-setting1"><a
                            href="${pageContext.request.contextPath}/user/findByName"> <i
                    ...
                    <li id="system-setting4"><a
                            href="${pageContext.request.contextPath}/sysLog/findByName"> <i
            ...
            <li class="treeview"><a href="#"> <i class="fa fa-cube"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li id="system-setting5"><a
                            href="${pageContext.request.contextPath}/product/findByName">
